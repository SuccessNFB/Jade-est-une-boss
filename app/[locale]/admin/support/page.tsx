                ...
                <div className="border-t border-gray-100 px-5 py-4 space-y-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#D4AF37] text-charcoal text-xs font-bold hover:bg-[#00EEFF] transition-colors disabled:opacity-50"
                    >
