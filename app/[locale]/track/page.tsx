      ...
      <main className="pt-20 pb-24">
        <div className="section-container max-w-2xl py-12">
            ...
            <div className="space-y-6">
              {STEPS.map(({ icon: Icon, title, desc }, i) => (
                <div key={title} className="flex gap-5">
                  <div className="relative z-10 w-10 h-10 rounded-full bg-white border-2 border-[#D4AF37]/30 flex items-center justify-center flex-shrink-0">
          ...
          <div className="rounded-2xl bg-gray-50 border border-gray-100 p-8 text-center">
            <Mail className="w-8 h-8 text-charcoal/20 mx-auto mb-3" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#D4AF37] text-charcoal font-bold text-sm hover:bg-[#00EEFF] hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all"
              >
                Nous contacter
              </Link>
              <a
