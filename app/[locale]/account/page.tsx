        ...
        <div className="section-container max-w-3xl py-10">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#00D9FF]/10 border border-[#00D9FF]/20 flex items-center justify-center">
                <span className="font-bold text-[#00D9FF] text-lg uppercase">
            ...
            {[
              ...
              >
                <div className="w-9 h-9 rounded-xl bg-[#0E0F16] shadow-sm flex items-center justify-center">
                  <Icon className="w-4 h-4 text-white/70 group-hover:text-[#00D9FF] transition-colors" />
                </div>
