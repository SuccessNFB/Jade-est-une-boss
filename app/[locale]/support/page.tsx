          ...
          {done ? (
            <div className="text-center py-16">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link href="/shop" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#00D9FF] text-charcoal font-bold text-sm hover:bg-[#00EEFF] transition-all">
            ...
            <>
              <div className="mb-8">
                <p className="text-xs font-bold tracking-widest uppercase text-[#00D9FF] mb-2">Support</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {CATEGORIES.map(({ value, label, icon: Icon }) => (
                      <button
                        ...
                        className={`flex items-center gap-2 px-3 py-3 rounded-xl border text-sm font-semibold transition-all text-left ${
                          category === value
                            ? 'border-[#00D9FF] bg-[#00D9FF]/10 text-charcoal'
                            : 'border-gray-200 bg-white text-charcoal/60 hover:border-gray-300'
                        }`}
                      >
                        <Icon className={`w-4 h-4 flex-shrink-0 ${category === value ? 'text-[#00D9FF]' : 'text-charcoal/30'}`} />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-charcoal placeholder-charcoal/25 outline-none focus:border-[#00D9FF]/60 transition-all"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-4 rounded-full bg-[#00D9FF] text-charcoal font-bold text-sm hover:bg-[#00EEFF] hover:shadow-[0_0_20px_rgba(0,217,255,0.4)] transition-all disabled:opacity-50"
                >
