  ...
  return (
    ...
    >
      <div className="w-full max-w-md text-center">
        ...
        <Link
          href="/auth/login"
          className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full border border-white/15 text-white/60 text-sm font-semibold hover:border-[#D4AF37]/40 hover:text-white transition-all"
        >
