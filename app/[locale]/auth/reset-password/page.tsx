        ...
        <div className="bg-white/[0.04] border border-white/10 rounded-3xl p-8 sm:p-10 backdrop-blur-sm">
          ...
          {state === 'request' && (
            <>
              <div className="text-center mb-8">
                <div className="w-14 h-14 rounded-2xl bg-[#00D9FF]/10 border border-[#00D9FF]/20 flex items-center justify-center mx-auto mb-4">
              ...
              <form onSubmit={handleRequest} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/20 text-sm outline-none focus:border-[#00D9FF]/60 transition-all"
                  />
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2.5 py-4 rounded-full bg-[#00D9FF] text-charcoal font-bold text-sm hover:bg-[#00EEFF] hover:shadow-[0_0_28px_rgba(0,217,255,0.5)] transition-all disabled:opacity-60"
                >
          ...
          {state === 'sent' && (
            <div className="text-center">
              <div className="w-14 h-14 rounded-2xl bg-[#00D9FF]/10 border border-[#00D9FF]/20 flex items-center justify-center mx-auto mb-5">
                <Mail className="w-6 h-6 text-[#00D9FF]" />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pr-12 text-white placeholder-white/20 text-sm outline-none focus:border-[#00D9FF]/60 transition-all"
                    />
                    <button
                      type="button"
