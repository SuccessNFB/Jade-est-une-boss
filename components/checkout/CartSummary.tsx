...
export function CartSummary() {
  ...
  return (
    <div className="space-y-4">
      <AnimatePresence>
        {items.map((item) => (
          <motion.div
            ...
            className="flex gap-4 p-4 rounded-2xl border border-white/[0.06] bg-[#141414]"
          >
            {/* Image */}
            <div className="relative w-20 h-20 flex-shrink-0 rounded-xl overflow-hidden bg-[#121210]">
              <Image
      ...
      {/* Totals */}
      <div className="rounded-2xl bg-[#121210] p-5 space-y-3">
