...
export function UserMenu() {
  ...
  if (!supaUser) {
    return (
      <Link
        href="/auth/login"
        className="p-2.5 text-white/60 hover:text-white transition-colors rounded-lg hover:bg-[#141414]/10 hidden sm:flex"
          ...
          >
            ...
            <div className="py-1">
              <Link
                ...
                className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-white/70 hover:text-white hover:bg-[#141414]/5 transition-colors"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-white/70 hover:text-white hover:bg-[#141414]/5 transition-colors"
              >
