  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      {TILES.slice(0, 4).map(({ icon: Icon, label, sub }) => (
        <div
          key={label}
          className="flex items-start gap-3 p-3.5 rounded-xl bg-[#121210] border border-white/[0.06]"
        >
          <div className="w-8 h-8 rounded-lg bg-[#141414] shadow-sm flex items-center justify-center flex-shrink-0">
