...
export function AnnouncementBar() {
  ...
  return (
    <div className="relative text-white text-xs py-2.5 px-10 text-center font-semibold tracking-widest" style={{ background: '#141412', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      <button
