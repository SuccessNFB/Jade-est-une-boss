...
const TIER_STYLES: Record<PriceTier, { bg: string; text: string; border: string }> = {
  entry:   { bg: 'rgba(212,175,55,0.08)',    text: '#D4AF37',  border: 'rgba(212,175,55,0.2)' },
  mid:     { bg: 'rgba(212,175,55,0.12)',    text: '#D4AF37',  border: 'rgba(212,175,55,0.25)' },
  premium: { bg: 'rgba(212,175,55,0.1)',    text: '#D4AF37',  border: 'rgba(212,175,55,0.2)' },
  luxury:  { bg: 'rgba(212,175,55,0.14)',   text: '#E8C572',  border: 'rgba(212,175,55,0.28)' },
  ultra:   { bg: 'rgba(212,175,55,0.18)',   text: '#E8C572',  border: 'rgba(232,200,120,0.35)' },
}
